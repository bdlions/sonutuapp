...
public class RecipeCommentsActivity extends Activity {
	...
	private void Process() {
		...
		try {
			...
			RCommentsCustomAdapter adapter = new RCommentsCustomAdapter(this, recipeCommentObjList);
			...
			public void onClick(View arg0) {
				...
				if(isVerifiedCommentTextStep()) {
					try {
						...
						jsonRecipeCommentObj.put("application_id", 1);
					...
					healthyRecipeapp.postrecipeComments(new ICallBack() {
						...
						public void callBackResultHandler(Object object) {
							...
							System.out.print(recipeCommentJSONObject);
							//JSONArray commentArray = RecipeComment
						}
