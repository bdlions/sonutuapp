...
public class EmailSettingsActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_email_setteing);
		this.mContext = this;
	...
	private void initUI() {
		emailChangeEdtTxt = (EditText) findViewById(R.id.emailChangeEdtTxt);
		btnNameChange = (Button) findViewById(R.id.btnNameChange);
		try {
			emailChangeEdtTxt.setText(userInfoJSONObj.getString("email"));
		} catch (JSONException e) {
